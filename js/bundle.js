...
/***/ function(module, exports, __webpack_require__) {
	...
	const ValidKeys = __webpack_require__(1);
	const Sounds = __webpack_require__(2);
	const anime = __webpack_require__(3);
	...
	const fireworks = (function(ctx, canvas) {
	  ...
	  const mainLoop = anime({
	    ...
	    update: function() {
	      ...
	      // ctx.font = '75px Happy Monkey';
	      // ctx.fillStyle = "#C70039";
	      // ctx.textAlign = "center";
	      // ctx.fillText("shuffle", canvas.width/2, canvas.height/2);
	      // ctx.font = '20px Happy Monkey';
	      // ctx.fillText("{ press any letter key }", canvas.width/2, canvas.height/2 + 40);
	  ...
	  $(document).keydown(function(e) {
	    ...
	    if (e.keyCode === undefined) {
	      ...
	      let b = window.innerHeight/2 - 130;
	...
	document.addEventListener("DOMContentLoaded", function(){
	  ...
	  let textAnimationDown = anime ({
	    ...
	    loop: false,
	    autoplay: false,
	    complete: instrAnimationDown.play
	  });
	  ...
	  let boom = function() {$(document).keydown();};
